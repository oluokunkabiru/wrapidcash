            ...
            <div class="col-md-6">
                ...
                <form action="{{ route('pay') }}" method="post"  accept-charset="UTF-8" class="form-horizontal" role="form">
                  ...
                  @csrf
                    ...
                    <input type="hidden" name="amount" value="{{ 100000 * 100 }}"> {{-- required in kobo --}}
                    ...
                    <button type="submit" class="btn btn-block btn-outline-light btn-rounded btn-primary text-uppercase font-weight-bold p-2" >Pay with card</button>
                </form>
