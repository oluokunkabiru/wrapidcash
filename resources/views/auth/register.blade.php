  ...
  --}}
                      ...
                      <div class="form-group form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="accept" name="accept">by click this box you have agreed with our <a href="#tModal" data-toggle="modal">terms and conditions</a>
                        </label>
                      </div>
