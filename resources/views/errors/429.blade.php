                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                             <h1 class="display-3 text-danger font-weight-bold">429</h1>
                        </div>
                        <div class="card-body">
                            <div class="alert alert-danger text-center">
                <p class="display-5">Oops! Something is wrong.</p>
                <h3> The page you are looking for has too many request </h3>
                <h3>Please try again by going back and refresh</h3>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="row card-footer">
                                    ...
                                    {{--  <div class="col">  --}}
                                        <a href="{{ route('home') }}" class="btn btn-lg btn-dark float-right mx-2" style="color: #E91E63;">Dashboard</a>
                                    {{--  </div>  --}}
                                </div>
                            </div>
                        </div>
